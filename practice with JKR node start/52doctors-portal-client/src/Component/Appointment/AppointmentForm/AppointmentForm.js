...
const AppointmentForm = ({ modalIsOpen, appointmentSub, date, closeModal }) => {
    ...
    return (
        <div>
            ...
            >
                <h2 className="text-center color-text">{appointmentSub}</h2>
                <p className="text-center color-text">On {date.toDateString()}</p>
                <form className="p-5" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="form-group text-right">
                        <button type="submit" className="btn brand-btn">Send</button>
                    </div>
                </form>
            </Modal>
        </div>
